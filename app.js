...
const translations = {
  vi: { topline:'LỊCH PHÁT SÓNG TOÀN CẦU', intro:'Bạn sẽ xem lúc mấy giờ? Nhập tên thành phố để đổi giờ phát sóng sang giờ địa phương.', cityLabel:'THÀNH PHỐ CỦA BẠN', placeholder:'Ví dụ: Ho Chi Minh City, Tokyo, London…', earlier:'SỚM HƠN', free:'MIỄN PHÍ', localTime:'GIỜ ĐỊA PHƯƠNG', premiere:'Buổi công chiếu đầu tiên', rockstarChannel:'Trên kênh Rockstar Games', difference:'YouTube phát sau Netflix', hours:'giờ', sameContent:'cùng một nội dung', converted:'Đã chuyển đổi từ giờ ET (UTC−4)', source:'Nguồn: Rockstar Games ↗', quick:'Hoặc chọn nhanh:', searching:'Đang tìm thành phố…', choose:'Chọn thành phố để xem giờ địa phương.', empty:'Không tìm thấy — thử thêm tên quốc gia.', offline:'Không kết nối được dữ liệu thành phố. Thử lại sau nhé.' },
  en: { topline:'GLOBAL PREMIERE TIMES', intro:'What time will you watch? Enter your city to convert the release times to your local time.', cityLabel:'YOUR CITY', placeholder:'e.g. Richmond, Tokyo, London…', earlier:'EARLIER', free:'FREE', localTime:'LOCAL TIME', premiere:'The first premiere', rockstarChannel:'On Rockstar Games channel', difference:'YouTube goes live after Netflix', hours:'hours', sameContent:'same content', converted:'Converted from ET (UTC−4)', source:'Source: Rockstar Games ↗', quick:'Quick picks:', searching:'Finding cities…', choose:'Choose a city to see local times.', empty:'No results — try adding a country.', offline:'Could not connect to city data. Try again.' },
  fr: { topline:'HORAIRES DE PREMIÈRE MONDIALE', intro:'À quelle heure allez-vous regarder ? Entrez votre ville pour convertir les horaires dans votre fuseau local.', cityLabel:'VOTRE VILLE', placeholder:'ex. Richmond, Tokyo, Londres…', earlier:'EN AVANCE', free:'GRATUIT', localTime:'HEURE LOCALE', premiere:'La première diffusion', rockstarChannel:'Sur la chaîne Rockstar Games', difference:'YouTube sera disponible après Netflix', hours:'heures', sameContent:'même contenu', converted:'Converti depuis l’ET (UTC−4)', source:'Source : Rockstar Games ↗', quick:'Choix rapides :', searching:'Recherche de villes…', choose:'Choisissez une ville pour voir l’heure locale.', empty:'Aucun résultat — essayez avec un pays.', offline:'Impossible de joindre les données. Réessayez.' }
};
let currentLang = 'vi';
